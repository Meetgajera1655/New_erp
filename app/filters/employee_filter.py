...
def apply_employee_filters(
    ...
    """
    Generates dynamic SQL WHERE clause and parameters for the Employee Management dashboard.
    Supports branch filtering and custom business date columns (date_of_joining, etc.).
